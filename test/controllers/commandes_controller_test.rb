...
class CommandesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commande" do
    assert_difference("Commande.count") do
      post commandes_url, params: { commande: { comment: @commande.comment, nom: @commande.nom } }
    end
  ...
  test "should update commande" do
    patch commande_url(@commande), params: { commande: { comment: @commande.comment, nom: @commande.nom } }
